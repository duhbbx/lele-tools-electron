...
const dict: Record<string, Record<Locale, string>> = {
  ...
  'crm.sourceXiaohongshu': { zh: '小红书', en: 'Xiaohongshu' },
  'crm.sourceXianyu': { zh: '咸鱼', en: 'Xianyu' },
  'crm.sourceReferral': { zh: '朋友介绍', en: 'Referral' },
  'crm.sourceWechat': { zh: '微信', en: 'WeChat' },
  'crm.sourceGithub': { zh: 'GitHub', en: 'GitHub' },
  'crm.sourceWebsite': { zh: '官网', en: 'Website' },
  'crm.sourceOther': { zh: '其他', en: 'Other' },
  'crm.shareAmount': { zh: '分润金额', en: 'Profit share' },
  'crm.total': { zh: '合计', en: 'Total' },
  'crm.payMethod': { zh: '方式', en: 'Method' },
  'crm.payBank': { zh: '对公', en: 'Bank transfer' },
  'crm.payWechat': { zh: '微信', en: 'WeChat' },
  'crm.payAlipay': { zh: '支付宝', en: 'Alipay' },
  'crm.payOther': { zh: '其他', en: 'Other' },
  'crm.docs': { zh: '文档', en: 'Documents' },
  'crm.upload': { zh: '上传', en: 'Upload' },
  'crm.open': { zh: '打开', en: 'Open' },
  'crm.size': { zh: '大小', en: 'Size' },
  'crm.uploadedAt': { zh: '上传时间', en: 'Uploaded' },
