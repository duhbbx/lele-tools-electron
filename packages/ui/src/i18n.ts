...
const dict: Record<string, Record<Locale, string>> = {
  ...
  'settings.ai.profile': { zh: '配置档', en: 'Profile' },
  'settings.ai.name': { zh: '名称', en: 'Name' },
  'settings.ai.addProfile': { zh: '新增配置', en: 'Add profile' },
  'settings.ai.removeProfile': { zh: '删除当前配置', en: 'Remove profile' },
  'settings.ai.activeHint': { zh: '上方所选即「当前使用」的配置', en: 'The selected profile is the active one' },
